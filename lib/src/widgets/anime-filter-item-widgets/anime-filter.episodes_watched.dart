...
class AnimeFilterEpisodesWatchedWidget extends StatefulWidget {
  const AnimeFilterEpisodesWatchedWidget({Key key}) : super(key: key);

  @override
  _AnimeFilterEpisodesWatchedWidgetState createState() => _AnimeFilterEpisodesWatchedWidgetState();
}

class _AnimeFilterEpisodesWatchedWidgetState extends State<AnimeFilterEpisodesWatchedWidget> with CoreStateMixin {
  @override
      ...
      builder: (context, height, width, sy, sx) {
        return MomentumBuilder(
          ...
          builder: (context, snapshot) {
            var filter = animeFilter.getFilter<AnimeFilterEpisodesWatchedData>();
            return Column(
              children: [
  ...
  Widget buildTypeWidget(AnimeFilterEpisodesWatchedData filter) {
  ...
  void updateFilter(AnimeFilterEpisodesWatchedData filter) {
