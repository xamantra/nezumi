...
class AnimeFilterTotalDurationWidget extends StatefulWidget {
  const AnimeFilterTotalDurationWidget({Key key}) : super(key: key);

  @override
  _AnimeFilterTotalDurationWidgetState createState() => _AnimeFilterTotalDurationWidgetState();
}

class _AnimeFilterTotalDurationWidgetState extends State<AnimeFilterTotalDurationWidget> with CoreStateMixin {
  @override
      ...
      builder: (context, height, width, sy, sx) {
        return MomentumBuilder(
          ...
          builder: (context, snapshot) {
            var filter = animeFilter.getFilter<AnimeFilterTotalDurationData>();
            return Column(
  ...
  Widget buildTypeWidget(AnimeFilterTotalDurationData filter) {
  ...
  void updateFilter(AnimeFilterTotalDurationData filter) {
