...
class AnimeFilterListStatusWidget extends StatefulWidget {
  const AnimeFilterListStatusWidget({Key key}) : super(key: key);

  @override
  _AnimeFilterListStatusWidgetState createState() => _AnimeFilterListStatusWidgetState();
}

class _AnimeFilterListStatusWidgetState extends State<AnimeFilterListStatusWidget> with CoreStateMixin {
  @override
      ...
      builder: (context, height, width, sy, sx) {
        return MomentumBuilder(
          ...
          builder: (context, snapshot) {
            var filter = animeFilter.getFilter<AnimeFilterListStatusData>();
            return Column(
              children: [
  ...
  void chooseStatus(AnimeFilterListStatusData filter) {
    var widget = Dialog(
  ...
  void updateFilter(AnimeFilterListStatusData filter) {
