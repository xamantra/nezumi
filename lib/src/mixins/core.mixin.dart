...
mixin CoreMixin<T> on MomentumController<T> {
  ...
  AnimeHistoryCacheService _animeHistoryCache;
  AnimeHistoryCacheService get animeHistoryCache {
    if (_animeHistoryCache == null) {
      _animeHistoryCache = service<AnimeHistoryCacheService>();
    }
    return _animeHistoryCache;
  }
...
mixin CoreStateMixin<T extends StatefulWidget> on State<T> {
  ...
  AnimeStatsController _animeStatsCtrl;
  AnimeStatsModel get animeStats {
    if (_animeStatsCtrl == null) {
      _animeStatsCtrl = ctrl<AnimeStatsController>(context);
    }
    return _animeStatsCtrl?.model;
  }
}
